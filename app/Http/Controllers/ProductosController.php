...
{
    /*servira para Crear los productos o registros en mi tabla productos 
    este método procesará los datos que envie mediante un formulario HTML de Bootstrap 5 más adelante.*/
